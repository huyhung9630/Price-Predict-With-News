...
def eval_model(data ,model, dataloader_test, symbol, mode, num_csvs, scaler):
      ...
      saving_folder = os.path.join(f"test_results",f"{symbol}_{mode}")
      os.makedirs(saving_folder, exist_ok=True)
      predicted_data_results_save_path = os.path.join(saving_folder, f'{symbol}_{mode}_predicted_data.csv')
      predicted_data_results.to_csv(predicted_data_results_save_path, index=False)

      os.makedirs(saving_folder, exist_ok=True)
      eval_df_save_path = os.path.join(saving_folder, f'{symbol}_{mode}_eval_data.csv')
...
for name in all_names:
    ...
    print(symbol_name)
    sentiment_predict(csv_data, symbol_name, num_stocks, True)
